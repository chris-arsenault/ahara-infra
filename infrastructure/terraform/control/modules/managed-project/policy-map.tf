...
module "grafana-dashboard-bootstrap" {
  source     = "../policy-library/grafana-dashboard-bootstrap"
  prefix     = var.prefix
  account_id = var.account_id
}
...
locals {
  policy_map = {
    ...
    "grafana-dashboard-bootstrap" = module.grafana-dashboard-bootstrap.policy_json
